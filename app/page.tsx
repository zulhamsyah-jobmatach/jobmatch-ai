...
export default function JobMatchLanding() {
  ...
  const steps = [
    {
      number: '01',
      title: 'Upload CV',
      desc: 'Upload CV kamu dalam format PDF. Cukup drag & drop, selesai dalam hitungan detik.',
      icon: (
    ...
    },
    {
      ...
      desc: 'Dapatkan 3 rekomendasi karir yang cocok dengan profil kamu, lengkap dengan roadmap untuk memulai.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const plans = [
    ...
    priceYearly: 'Upgrade ke Pro setelah 5 CV',
      ...
      features: [
        '5 analisis CV per bulan',
            '3 rekomendasi karir personal',
            'Roadmap 3 langkah per karir',
            'AI Career Coach standar',
            'Support via email',
      ],
      cta: 'Mulai Gratis',
      highlight: false,
    ...
    priceYearly: 'Rp 39.000',
      ...
      features: [
        'UNLIMITED analisis CV',
            '5 rekomendasi karir mendalam',
            'Roadmap 5-10 langkah detail',
            'AI Deep Analysis (prompt premium)',
    ...
    <div className="min-h-screen bg-white font-sans antialiased">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-lg bg-white/70 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a
          href="/bikin-cv"
        className="mr-3 text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition hidden md:inline-flex items-center gap-1"
      >
        ✨ Bikin CV AI
      </a>
          <button
      ...
      <section className="relative pt-32 pb-24 overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <a
            href="/bikin-cv"
  className="group px-8 py-4 rounded-full border-2 border-white text-white font-bold hover:bg-white/10 transition flex items-center gap-2"
>
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
  </svg>
  Belum Punya CV? Bikin AI
