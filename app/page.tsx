  ...
  const plans = [
    {
      ...
      price: 'Gratis',
      period: '',
      desc: 'Mulai gratis, upgrade ke Rp 99K/bulan setelah melebihi 5 CV.',
      features: [
        '5 CV upload per bulan (gratis)',
        'Setelah limit: Rp 99K/bulan',
        'Rekomendasi karir basic',
        'AI matching dasar',
        'Email support',
      ],
      cta: 'Mulai Gratis',
    ...
    },
    {
      ...
      price: 'Rp 499.000',
      period: '/bulan',
      desc: 'Untuk pencari kerja serius yang ingin hasil maksimal.',
      features: [
        'CV upload tanpa batas',
        'Rekomendasi karir lengkap + roadmap',
        'AI matching premium',
        'CV review oleh AI',
    ...
    },
    {
      ...
      features: [
        'Post lowongan tanpa batas',
        'Screen 500 CV otomatis per bulan',
